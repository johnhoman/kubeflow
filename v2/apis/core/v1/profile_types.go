...
type ProfileConfigUserSpec struct {
	IDHeader string `json:"idHeader,omitempty"`
	IDPrefix string `json:"idPrefix,omitempty"`
}

type ProfileConfigNamespaceSpec struct {
	Prefix string            `json:"prefix,omitempty"`
	Labels map[string]string `json:"labels,omitempty"`
}

type ProfileConfigRole struct {
	Edit  string `json:"edit,omitempty"`
	View  string `json:"view,omitempty"`
	Admin string `json:"admin,omitempty"`
}

type ProfilePluginSpec struct {
	GCPServiceAccount *string `json:"gcpServiceAccount,omitempty"`
	AWSIAMRole        *string `json:"awsIamRole,omitempty"`
}

type ProfilePlugin struct {
	Spec ProfilePluginSpec `json:"spec,omitempty"`
}

type ProfileConfigSpec struct {
	User        ProfileConfigUserSpec      `json:"user,omitempty"`
	Namespace   ProfileConfigNamespaceSpec `json:"namespace,omitempty"`
	Role        ProfileConfigRole          `json:"role,omitempty"`
	Plugins     []ProfilePlugin            `json:"plugins,omitempty"`
	GlobalQuota *corev1.ResourceQuotaSpec  `json:"quota,omitempty"`
}
...
type ProfileConfig struct {
	...
	Spec ProfileConfigSpec `json:"spec,omitempty"`
}
